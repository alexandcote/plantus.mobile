...
const WaterLevel = ({ scale = 1, color = '#000' }: PropTypes) => {
  const size = 338.839;
  ...
  return (
    <Svg width={realSize} height={realSize}>
      <G scale={realScale}>
        <Path
            d="M320.392,18.183c-10.189,0-18.446,8.259-18.446,18.446V62.78l-34.756,20.882c-2.774,1.675-9.344,1.618-12.105-0.129
        ...
        <Path
            d="M178.69,148.484c-5.125-5.122-13.417-5.122-18.54,0l-40.172,40.175c-5.122,5.116-3.399,9.271,3.837,9.271h19.38v39.325
